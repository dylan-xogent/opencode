...
OpenCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/anomalyco/opencode/releases) oder [awareness.dev/download](https://awareness.dev/download) herunter.
...
Mehr dazu unter [Agents](https://awareness.dev/docs/agents).

### Dokumentation

Mehr Infos zur Konfiguration von OpenCode findest du in unseren [**Docs**](https://awareness.dev/docs).
