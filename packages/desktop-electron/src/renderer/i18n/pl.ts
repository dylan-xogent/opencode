export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Awareness",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Awareness. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'awareness'.",
