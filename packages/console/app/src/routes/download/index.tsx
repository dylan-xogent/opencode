          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://awareness.dev/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>awareness.dev/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g awareness-ai")}>
                <code>
                  npm i -g <strong>awareness-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g awareness-ai")}>
                <code>
                  bun add -g <strong>awareness-ai</strong>
                </code>
                <CopyStatus />
              </button>
