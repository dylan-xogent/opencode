...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Awareness | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Awareness terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Awareness. Please read on to learn the rules and restrictions that govern your use of
                Awareness&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Awareness," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://awareness.dev/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-opencode">What is Awareness?</h2>
              <p>
                Awareness is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Awareness Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Awareness enables you to
              ...
              <p>
                ...
                our site located at awareness.dev, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Awareness takes the privacy of its users very seriously. For the current Awareness Privacy Policy, please
                click here{" "}
                <a href="https://awareness.dev/legal/privacy-policy">https://awareness.dev/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Awareness?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Awareness;
                </li>
                <li>
              ...
              <p>
                If you use Awareness with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Awareness. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Awareness has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opencode-ever-change-the-services">Will Awareness ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://awareness.dev/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://awareness.dev/auth">https://awareness.dev/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://awareness.dev/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                Awareness is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Awareness has the sole right to decide whether you are
              ...
              <p>
                Awareness and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Awareness and all such
                parties together, the "Awareness Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Awareness Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Awareness Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Awareness Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Awareness's prior written
              ...
              <p>
                ...
                disputes and claims with Awareness and limits the manner in which you can seek relief from Awareness. Both
                you and Awareness acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Awareness's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Awareness will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Awareness will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Awareness may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and Awareness are instead choosing to have claims and disputes resolved by
                ...
                you and Awareness over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                Awareness is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Awareness to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Awareness agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Awareness may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Awareness agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Awareness, and
                ...
                are not an employee, agent, partner, or joint venture of Awareness, and you do not have any authority of
                any kind to bind Awareness in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Awareness
