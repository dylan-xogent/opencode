...
beforeAll(async () => {
  ...
  mock.module("@awareness/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@awareness/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@awareness/ui/icon", () => ({ Icon: () => null }))
  mock.module("@awareness/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
