export const dict = {
  ...
  "dialog.provider.awareness.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.awareness.tagline": "Modelos optimizados y fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Awareness",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Awareness.",
  ...
  "provider.connect.opencodeZen.line1":
    "Awareness Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Awareness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Awareness.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Awareness se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Awareness ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Awareness",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Awareness no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Awareness incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Awareness dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Awareness",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Awareness en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Awareness sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Awareness.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Awareness",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Awareness.",
