export const dict = {
  ...
  "dialog.provider.awareness.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.awareness.tagline": "Pålidelige optimerede modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Awareness",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Awareness.",
  ...
  "provider.connect.opencodeZen.line1":
    "Awareness Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Awareness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Awareness.",
  ...
  "dialog.server.description": "Skift hvilken Awareness-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Awareness ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Awareness-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Awareness understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Awareness inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Awareness-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Awareness",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Awareness ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Awareness følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Awareness er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Awareness starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Awareness.",
