export const dict = {
  ...
  "dialog.provider.awareness.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.awareness.tagline": "Modèles optimisés et fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Awareness",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Awareness.",
  ...
  "provider.connect.opencodeZen.line1":
    "Awareness Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.opencodeZen.visit.link": "awareness.dev/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Awareness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Awareness.",
  ...
  "dialog.server.description": "Changez le serveur Awareness auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Awareness ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Awareness",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Awareness ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Awareness inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "Awareness Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Awareness dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Awareness",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Awareness sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Awareness suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Awareness.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Awareness",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Awareness.",
