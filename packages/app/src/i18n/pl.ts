export const dict = {
  ...
  "dialog.provider.awareness.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.awareness.tagline": "Niezawodne, zoptymalizowane modele",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Awareness",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Awareness.",
  ...
  "provider.connect.opencodeZen.line1":
    "Awareness Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Awareness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Awareness.",
  ...
  "dialog.server.description": "Przełącz serwer Awareness, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Awareness ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Awareness",
  ...
  "sidebar.gettingStarted.line1": "Awareness zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Awareness",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Awareness na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Awareness ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Awareness.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Awareness",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Awareness.",
