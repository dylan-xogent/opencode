...
export const dict = {
  ...
  "dialog.provider.awareness.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.awareness.tagline": "Pålitelige, optimaliserte modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Awareness",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Awareness.",
  ...
  "provider.connect.opencodeZen.line1":
    "Awareness Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Awareness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Awareness.",
  ...
  "dialog.server.description": "Bytt hvilken Awareness-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Awareness ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Awareness-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Awareness ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Awareness inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Awareness-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Awareness",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Awareness ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Awareness skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Awareness er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Awareness starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Awareness.",
