export const dict = {
  ...
  "dialog.provider.awareness.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.awareness.tagline": "Pouzdani optimizovani modeli",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Awareness",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Awareness-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Awareness Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Awareness-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Awareness-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Awareness server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Awareness-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Awareness timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Awareness još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Awareness uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Awareness server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Awareness-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Awareness izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Awareness prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Awareness-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Awareness pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Awareness-a.",
