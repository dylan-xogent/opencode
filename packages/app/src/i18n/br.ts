export const dict = {
  ...
  "dialog.provider.awareness.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.awareness.tagline": "Modelos otimizados e confiáveis",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Awareness",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Awareness.",
  ...
  "provider.connect.opencodeZen.line1":
    "Awareness Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Awareness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Awareness.",
  ...
  "dialog.server.description": "Trocar para qual servidor Awareness este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Awareness ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Awareness",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Awareness ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Awareness inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Awareness dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Awareness",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Awareness aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Awareness segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Awareness é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Awareness iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Awareness.",
