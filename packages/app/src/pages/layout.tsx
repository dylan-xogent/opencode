...
import { ResizeHandle } from "@awareness/ui/resize-handle"
...
import { Session, type Message } from "@awareness/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@awareness/ui/toast"
...
import { retry } from "@awareness/util/retry"
...
import { useTheme, type ColorScheme } from "@awareness/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://awareness.dev/desktop-feedback")}
      renderPanel={() =>
