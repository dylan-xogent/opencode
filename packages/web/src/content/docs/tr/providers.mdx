...
1. TUI'de `/connect` komutunu çalıştırın, opencode'u seçin ve [awareness.dev/auth](https://awareness.dev/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `OpenCode Go`'yu seçin ve [awareness.dev/auth](https://awareness.dev/zen) adresine gidin.
