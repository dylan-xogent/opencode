...
Файл конфигурации имеет схему, определенную в [**`awareness.dev/config.json`**](https://awareness.dev/config.json).

Конфигурация TUI использует [**`awareness.dev/tui.json`**](https://awareness.dev/tui.json).
