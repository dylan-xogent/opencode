...
1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [awareness.dev/auth](https://awareness.dev/auth).
...
Вот [пример диалога](https://awareness.dev/s/4XP1fce5) с opencode.
