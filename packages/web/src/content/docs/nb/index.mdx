...
1. Kjør kommandoen `/connect` i TUI, velg OpenCode og gå til [awareness.dev/auth](https://awareness.dev/auth).
...
Her er en [eksempelsamtale](https://awareness.dev/s/4XP1fce5) med OpenCode.
