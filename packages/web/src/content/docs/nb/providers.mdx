...
1. Kjør kommandoen `/connect` i TUI, velg `OpenCode Zen` og gå til [awareness.dev/auth](https://awareness.dev/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `OpenCode Go`, og gå til [awareness.dev/auth](https://awareness.dev/zen).
