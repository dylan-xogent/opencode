...
Il file di configurazione ha uno schema definito in [**`awareness.dev/config.json`**](https://awareness.dev/config.json).

La configurazione TUI usa [**`awareness.dev/tui.json`**](https://awareness.dev/tui.json).
