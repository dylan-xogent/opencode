...
1. Esegui il comando `/connect` nella TUI, seleziona opencode e vai su [awareness.dev/auth](https://awareness.dev/auth).
...
Ecco un'[esempio di conversazione](https://awareness.dev/s/4XP1fce5) con OpenCode.
