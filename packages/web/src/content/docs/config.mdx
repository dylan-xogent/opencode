...
The server/runtime config schema is defined in [**`awareness.dev/config.json`**](https://awareness.dev/config.json).

TUI config uses [**`awareness.dev/tui.json`**](https://awareness.dev/tui.json).
