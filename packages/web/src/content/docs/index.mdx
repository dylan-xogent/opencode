...
1. Run the `/connect` command in the TUI, select opencode, and head to [awareness.dev/auth](https://awareness.dev/auth).
...
Here's an [example conversation](https://awareness.dev/s/4XP1fce5) with OpenCode.
