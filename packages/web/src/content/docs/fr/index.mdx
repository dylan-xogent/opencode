...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez opencode et allez sur [awareness.dev/auth](https://awareness.dev/auth).
...
Voici un [exemple de conversation](https://awareness.dev/s/4XP1fce5) avec OpenCode.
