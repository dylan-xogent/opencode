...
Le fichier de configuration a un schéma défini dans [**`awareness.dev/config.json`**](https://awareness.dev/config.json).

La configuration TUI utilise [**`awareness.dev/tui.json`**](https://awareness.dev/tui.json).
