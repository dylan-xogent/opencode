...
ไฟล์กำหนดค่ามีสคีมาที่กำหนดไว้ใน [**`awareness.dev/config.json`**](https://awareness.dev/config.json)

การกำหนดค่า TUI ใช้ [**`awareness.dev/tui.json`**](https://awareness.dev/tui.json)
