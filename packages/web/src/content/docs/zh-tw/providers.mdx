...
1. 在 TUI 中執行 `/connect` 指令，選擇 `OpenCode Zen`，然後前往 [awareness.dev/auth](https://awareness.dev/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `OpenCode Go`，然後前往 [awareness.dev/auth](https://awareness.dev/zen)。
