...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie OpenCode aus und gehen Sie zu [awareness.dev/auth](https://awareness.dev/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `OpenCode Go` und gehen Sie zu [awareness.dev/auth](https://awareness.dev/zen).
