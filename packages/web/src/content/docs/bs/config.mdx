...
Konfiguracijski fajl ima šemu koja je definirana u [**`awareness.dev/config.json`**](https://awareness.dev/config.json).

TUI konfiguracija koristi [**`awareness.dev/tui.json`**](https://awareness.dev/tui.json).
