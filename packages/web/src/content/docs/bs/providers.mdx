...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite opencode i idite na [awareness.dev/auth](https://awareness.dev/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `OpenCode Go` i idite na [awareness.dev/auth](https://awareness.dev/zen).
