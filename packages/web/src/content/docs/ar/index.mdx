...
1. شغّل الأمر `/connect` في واجهة TUI، واختر opencode، ثم انتقل إلى [awareness.dev/auth](https://awareness.dev/auth).
...
إليك [مثالا لمحادثة](https://awareness.dev/s/4XP1fce5) مع OpenCode.
