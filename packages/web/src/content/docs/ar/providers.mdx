...
1. شغّل الأمر `/connect` في TUI، واختر opencode، ثم انتقل إلى [awareness.dev/auth](https://awareness.dev/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `OpenCode Go`، ثم انتقل إلى [awareness.dev/auth](https://awareness.dev/zen).
