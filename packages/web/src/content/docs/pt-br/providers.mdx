...
1. Execute o comando `/connect` no TUI, selecione `OpenCode Zen` e acesse [awareness.dev/zen](https://awareness.dev/zen).
...
1. Execute o comando `/connect` no TUI, selecione `OpenCode Go` e acesse [awareness.dev/zen](https://awareness.dev/zen).
