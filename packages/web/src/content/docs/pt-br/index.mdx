...
1. Execute o comando `/connect` no TUI, selecione opencode e acesse [awareness.dev/auth](https://awareness.dev/auth).
...
Aqui está uma [conversa de exemplo](https://awareness.dev/s/4XP1fce5) com o opencode.
