...
O esquema de configuração do servidor/tempo de execução é definido em [**`awareness.dev/config.json`**](https://awareness.dev/config.json).

A configuração do TUI usa [**`awareness.dev/tui.json`**](https://awareness.dev/tui.json).
