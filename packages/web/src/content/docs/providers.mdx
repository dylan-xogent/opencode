...
1. Run the `/connect` command in the TUI, select `OpenCode Zen`, and head to [awareness.dev/auth](https://awareness.dev/zen).
...
1. Run the `/connect` command in the TUI, select `OpenCode Go`, and head to [awareness.dev/auth](https://awareness.dev/zen).
