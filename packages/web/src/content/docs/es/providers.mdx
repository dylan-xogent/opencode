...
1. Ejecute el comando `/connect` en TUI, seleccione opencode y diríjase a [awareness.dev/auth](https://awareness.dev/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `OpenCode Go` y diríjase a [awareness.dev/auth](https://awareness.dev/zen).
