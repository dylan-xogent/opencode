...
1. Ejecute el comando `/connect` en la TUI, seleccione opencode y diríjase a [awareness.dev/auth](https://awareness.dev/auth).
...
Aquí tiene una [conversación de ejemplo](https://awareness.dev/s/4XP1fce5) con OpenCode.
