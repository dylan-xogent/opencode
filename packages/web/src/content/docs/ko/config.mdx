...
server/runtime config schema는 [**`awareness.dev/config.json`**](https://awareness.dev/config.json)에 정의되어 있습니다.

TUI config는 [**`awareness.dev/tui.json`**](https://awareness.dev/tui.json)을 사용합니다.
