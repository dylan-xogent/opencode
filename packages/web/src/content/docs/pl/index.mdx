...
1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [awareness.dev/auth](https://awareness.dev/auth).
...
Oto [przykładowa rozmowa](https://awareness.dev/s/4XP1fce5) z opencode.
