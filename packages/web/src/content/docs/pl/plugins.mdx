...
import type { Plugin } from "@awareness/plugin"
...
import { type Plugin, tool } from "@awareness/plugin"
...
Poziomy: `debug`, `info`, `warn`, `error`. Aby uzyskać szczegółowe informacje, zobacz [dokumentację pakietu SDK](https://awareness.dev/docs/sdk).
