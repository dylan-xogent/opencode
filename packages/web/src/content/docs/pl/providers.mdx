...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCode Zen` i przejdź do [awareness.dev/auth](https://awareness.dev/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCode Go` i przejdź do [awareness.dev/auth](https://awareness.dev/zen).
