...
サーバー/ランタイム構成スキーマは [**`awareness.dev/config.json`**](https://awareness.dev/config.json) で定義されています。

TUI 設定は [**`awareness.dev/tui.json`**](https://awareness.dev/tui.json) を使用します。
