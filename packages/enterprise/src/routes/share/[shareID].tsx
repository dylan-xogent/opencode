import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@awareness/sdk/v2"
import { SessionTurn } from "@awareness/ui/session-turn"
import { SessionReview } from "@awareness/ui/session-review"
import { DataProvider } from "@awareness/ui/context"
import { FileComponentProvider } from "@awareness/ui/context/file"
import { WorkerPoolProvider } from "@awareness/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@awareness/ui/logo"
import { IconButton } from "@awareness/ui/icon-button"
import { ProviderIcon } from "@awareness/ui/provider-icon"
import { iife } from "@awareness/util/iife"
import { Binary } from "@awareness/util/binary"
import { NamedError } from "@awareness/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@awareness/ui/tabs"
import { MessageNav } from "@awareness/ui/message-nav"
import { FileSSR } from "@awareness/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@awareness/ui/pierre/worker").then((m) => ({
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Awareness</Title>
              </Show>
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              ...
                              <IconButton
                                as={"a"}
                                href="https://awareness.dev/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
