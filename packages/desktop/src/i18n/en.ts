export const dict = {
  ...
  "desktop.menu.help.documentation": "Awareness Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "Awareness CLI binary is missing. Try reinstalling the desktop app.",
