export const dict = {
  ...
  "desktop.menu.help.documentation": "Awareness Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Awareness CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
