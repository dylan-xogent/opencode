...
O OpenCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/anomalyco/opencode/releases) ou em [awareness.dev/download](https://awareness.dev/download).
...
Saiba mais sobre [agents](https://awareness.dev/docs/agents).

### Documentação

Para mais informações sobre como configurar o OpenCode, [**veja nossa documentação**](https://awareness.dev/docs).
