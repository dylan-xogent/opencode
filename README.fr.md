...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/anomalyco/opencode/releases) ou [awareness.dev/download](https://awareness.dev/download).
...
En savoir plus sur les [agents](https://awareness.dev/docs/agents).

### Documentation

Pour plus d'informations sur la configuration d'OpenCode, [**consultez notre documentation**](https://awareness.dev/docs).
