...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/anomalyco/opencode/releases) або [awareness.dev/download](https://awareness.dev/download).
...
Дізнайтеся більше про [agents](https://awareness.dev/docs/agents).

### Документація

Щоб дізнатися більше про налаштування OpenCode, [**перейдіть до нашої документації**](https://awareness.dev/docs).
