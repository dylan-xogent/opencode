...
- Core pieces:
  ...
  - `packages/plugin`: Source for `@awareness/plugin`
...
- **Denounced users** are explicitly blocked. Issues and pull requests from denounced users are automatically closed. If you have been denounced, you can request to be unvouched by reaching out to a maintainer on [Discord](https://awareness.dev/discord)
