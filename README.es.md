...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/opencode/releases) o desde [awareness.dev/download](https://awareness.dev/download).
...
Más información sobre [agents](https://awareness.dev/docs/agents).

### Documentación

Para más información sobre cómo configurar OpenCode, [**ve a nuestra documentación**](https://awareness.dev/docs).
