...
OpenCode cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/anomalyco/opencode/releases) hoặc [awareness.dev/download](https://awareness.dev/download).
...
Tìm hiểu thêm về [agents](https://awareness.dev/docs/agents).

### Tài liệu

Để biết thêm thông tin về cách cấu hình OpenCode, [**hãy truy cập tài liệu của chúng tôi**](https://awareness.dev/docs).
