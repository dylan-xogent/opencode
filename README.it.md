...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/anomalyco/opencode/releases) oppure da [awareness.dev/download](https://awareness.dev/download).
...
Scopri di più sugli [agenti](https://awareness.dev/docs/agents).

### Documentazione

Per maggiori informazioni su come configurare OpenCode, [**consulta la nostra documentazione**](https://awareness.dev/docs).
