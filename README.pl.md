...
<p align="center">
  <a href="https://awareness.dev/discord"><img alt="Discord" src="https://img.shields.io/discord/1391832426048651334?style=flat-square&label=discord" /></a>
...
[![OpenCode Terminal UI](packages/web/src/assets/lander/screenshot.png)](https://awareness.dev)
...
```bash
# YOLO
curl -fsSL https://awareness.dev/install | bash
...
OpenCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/anomalyco/opencode/releases) lub z [awareness.dev/download](https://awareness.dev/download).
...
```bash
# Przykłady
OPENCODE_INSTALL_DIR=/usr/local/bin curl -fsSL https://awareness.dev/install | bash
XDG_BIN_DIR=$HOME/.local/bin curl -fsSL https://awareness.dev/install | bash
```
...
Dowiedz się więcej o [agents](https://awareness.dev/docs/agents).

### Dokumentacja

Więcej informacji o konfiguracji OpenCode znajdziesz w [**dokumentacji**](https://awareness.dev/docs).
...
- 100% open source
- Niezależne od dostawcy. Chociaż polecamy modele oferowane przez [OpenCode Zen](https://awareness.dev/zen); OpenCode może być używany z Claude, OpenAI, Google, a nawet z modelami lokalnymi. W miarę jak modele ewoluują, różnice będą się zmniejszać, a ceny spadać, więc ważna jest niezależność od dostawcy.
